...
export default defineConfig({
          ...
          try {
            ...
            if (today.getMonth() === 5) {
              ...
              function applyJuneLogo() {
                var logos = document.querySelectorAll("img.logo, img[src*='logo.ico']");
              ...
              window.__oswApplyJuneLogo = applyJuneLogo;
            }
          } catch (e) {}
        })();
        `
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright:
        `© ${new Date().getFullYear()}, Estd 2025.</a>` +
        `<br/> This site does not host any files.`
    },
    editLink: {
      pattern:
        'https://github.com/YousefMohsen0/OurServersWiki/tree/main/docs/:path',
      text: '📝 عدل علي الصفحة دي'
    },
    outline: 'deep',
    logo: {
      src: '/logo.ico',
